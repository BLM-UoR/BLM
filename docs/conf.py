...
.. only:: html
    ...
    .. nbinfo::
        ...
        Slideshow:
        :raw-html:`<a href="https://nbviewer.jupyter.org/github/Urban-Meteorology-Reading/BLM/tree/master?filepath={{ docname }}#"><img alt="Binder badge" src="https://img.shields.io/badge/render-nbviewer-orange.svg" style="vertical-align:text-bottom"></a>`
